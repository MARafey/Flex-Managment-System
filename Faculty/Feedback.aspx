<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Feedback.aspx.cs" Inherits="FeedbackFromStudents" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <section>
            <h2>Feedback from Students Page</h2>
            <p>
            ...
            <br>
                <asp:Button ID="GetFeedbackBtn" runat="server" Text="Get Feedback" OnClick="GetFeedbackBtn_Click" CssClass="button" />
            
            <br />
            <br />
            Approval Percentage: <asp:Label ID="Label1" runat="server"></asp:Label>
&nbsp;<div id="feedback">
                <asp:GridView ID="GridView1" runat="server" Width="1449px">
                </asp:GridView>
            </div>
        </section>
    </form>
