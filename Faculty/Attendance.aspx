<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Attendance.aspx.cs" Inherits="FacultyAttendance" %>
    ...
    <form id="form1" runat="server">
        ...
        <section>
            ...
            <br/><br/>
                ...
                <br><br>
                <asp:Button CssClass="button" ID="ShowStudentsBtn" runat="server" Text="Show Students" OnClick="ShowStudentsBtn_Click" />
            
            
            
            <br />
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" DataKeyNames="" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                <Columns>
                    <asp:BoundField DataField="StudentID" HeaderText="Name" />
                    <asp:TemplateField HeaderText="Attendance">
                        <ItemTemplate>
                            <asp:DropDownList ID="AttendanceList" runat="server" AutoPostBack="True">
            ...
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Mark Attendance" CssClass="button " />
        </section>
    </form>
</body>
</html>
